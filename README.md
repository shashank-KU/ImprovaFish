...
For all the commands used for downstream analysis for [trascriptomics](https://shashank-ku.github.io/ImprovaFish/MetaTranscriptomics/Step1_Host_Analysis.html)
