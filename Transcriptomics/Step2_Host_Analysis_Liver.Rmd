...
```{r, echo=TRUE, error=FALSE, warning=FALSE, message=FALSE, figures-side, fig.show="hold", out.width="50%", fig.cap="Gene Ontology (GO) analysis"}
# save all the plots
setwd("/Users/shashankgupta/Desktop/ImprovAFish/github/ImprovaFish/Transcriptomics/intermediate_files/Liver")
...
```{r, echo=TRUE, error=FALSE, warning=FALSE, message=FALSE, out.width="50%", fig.cap="KEGG pathway analysis"}
setwd("/Users/shashankgupta/Desktop/ImprovAFish/github/ImprovaFish/Transcriptomics/intermediate_files/Liver")
