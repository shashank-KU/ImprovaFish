...
```{r, warning=FALSE, message=FALSE}
# if (!file.exists("/Users/shashankgupta/Desktop/ImprovAFish/github/ImprovaFish/Transcriptomics/intermediate_files/Liver")) {
...
# save all the plots
# dir.create("/Users/shashankgupta/Desktop/ImprovAFish/github/ImprovaFish/Transcriptomics/intermediate_files/Liver/GO")
# setwd("/Users/shashankgupta/Desktop/ImprovAFish/github/ImprovaFish/Transcriptomics/intermediate_files/Liver/GO")
...
# Set the working directory to the directory containing the PNG files
# setwd("/Users/shashankgupta/Desktop/ImprovAFish/github/ImprovaFish/Transcriptomics/intermediate_files/Liver/GO")

# Get a list of all PNG files in the directory
png_files <- list.files(pattern = "^resGO_dotplot_.*\\.png$")

# Read all PNG files into a list of raster objects
raster_list <- lapply(png_files, readPNG)

# Combine all raster objects into a single plot using gridExtra::grid.arrange()
...
```{r, fig.height=20, message=FALSE, fig.width=10, fig.cap= '<div style="text-align:center; color:red; font-size: 14pt;">KEGG pathway analysis</div>'}
# dir.create("/Users/shashankgupta/Desktop/ImprovAFish/github/ImprovaFish/Transcriptomics/intermediate_files/Liver/KEGG")
# setwd("/Users/shashankgupta/Desktop/ImprovAFish/github/ImprovaFish/Transcriptomics/intermediate_files/Liver/KEGG")
