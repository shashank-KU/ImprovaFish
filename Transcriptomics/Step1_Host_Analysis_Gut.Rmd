...
comparing functional profiles (GO) of genes in all the  modules. Genes and functional categories (i.e., pathways) are encoded as pies to distinguish different modules.
...
comparing functional profiles (KEGG) of genes in all the  modules. Genes and functional categories (i.e., pathways) are encoded as pies to distinguish different modules.
