...
annot1 <- read.csv("/Users/shashankgupta/Desktop/ImprovAFish/github/ImprovaFish/Input/Salmo_salar-GCA_905237065.2_gene_annotations.csv", header = TRUE)
...
dir.create("/Users/shashankgupta/Desktop/ImprovAFish/github/ImprovaFish/MetaTranscriptomics/intermediate_files")
setwd("/Users/shashankgupta/Desktop/ImprovAFish/github/ImprovaFish/MetaTranscriptomics/intermediate_files")
...
```{r, error=FALSE, warning=FALSE, message=FALSE, figures-side, fig.show="hold", out.width="50%", fig.cap="Gene Ontology (GO) analysis"}
# save all the plots
setwd("/Users/shashankgupta/Desktop/ImprovAFish/github/ImprovaFish/MetaTranscriptomics/intermediate_files")
...
```{r, error=FALSE, warning=FALSE, message=FALSE,fig.show="hold", out.width="50%", fig.cap="KEGG pathway analysis"}
