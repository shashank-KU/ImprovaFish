...
```{r, warning=FALSE, message=FALSE, error=FALSE,fig.height=6}
heatmap_colors <- colorRampPalette(rev(RColorBrewer::brewer.pal(n = 6, name ="RdBu")))(51)
...
cowplot::plot_grid(Z_corr_X_plot$gtable,
                   ...
                   rel_widths = c(dim(Z_traits)[2]/3, 
                                  ifelse(take_average,dim(wgcna_transcriptomics_Liver_eigengenes)[1]/2,dim(wgcna_transcriptomics_Liver_eigengenes)[1]/6),
...
```{r, warning=FALSE, message=FALSE, error=FALSE, fig.align='center',fig.height=8}
